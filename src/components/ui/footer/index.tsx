    ...
    <footer className='fixed bottom-0 w-full bg-background p-4 text-textSecondary'>
      <div className='container mx-auto flex items-center justify-center space-y-2 md:flex-row md:space-y-0'>
        ...
        <span>
          ...
          >
            <Github size={24} strokeWidth={1.5} className='inline-block ml-4 fill-background rounded-full p-0' />
          </Link>
          <Link
            ...
            className="hover:opacity-80"
          >
            <Linkedin size={24} strokeWidth={1.5} className='inline-block ml-4 fill-background rounded-full p-0' />
          </Link>
        </span>
